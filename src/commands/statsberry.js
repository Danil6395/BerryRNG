  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: '🟡 Всего легендарных (L)', value: formatNumber(legendaryCount), inline: true },
        { name: '💗 Всего мифических (M)', value: formatNumber(mythicCount), inline: true },
        { name: '❤️‍🔥 Всего секретных (S)', value: formatNumber(secretCount), inline: true },
      )
